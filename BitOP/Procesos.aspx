...
<p>
    ...
    <p>
        <asp:SqlDataSource ID="BopDBProc" runat="server" ConnectionString="<%$ ConnectionStrings:BopDBConnectionString %>" DeleteCommand="DELETE FROM [Procesos] WHERE [Proceso] = @Proceso" InsertCommand="INSERT INTO [Procesos] ([Proceso], [Descripción], [Fecha Creación], [Estado], [Area]) VALUES (@Proceso, @Descripción, @Fecha_Creación, @Estado, @Area)" SelectCommand="SELECT * FROM [Procesos] WHERE ([Area] = @Area)" UpdateCommand="UPDATE [Procesos] SET [Descripción] = @Descripción, [Fecha Creación] = @Fecha_Creación, [Estado] = @Estado, [Area] = @Area WHERE [Proceso] = @Proceso">
            <DeleteParameters>
