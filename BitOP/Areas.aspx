...
<p>
    ...
    <asp:SqlDataSource ID="BopDBAreas" runat="server" ConnectionString="<%$ ConnectionStrings:BopDBConnectionString %>" DeleteCommand="DELETE FROM [Areas] WHERE [Area] = @Area" InsertCommand="INSERT INTO [Areas] ([Area], [Descripción], [Estado], [Planta], [CCosto]) VALUES (@Area, @Descripción, @Estado, @Planta, @CCosto)" SelectCommand="SELECT [Area], [Descripción], [Estado], [Planta], [CCosto] FROM [Areas]" UpdateCommand="UPDATE [Areas] SET [Descripción] = @Descripción, [Estado] = @Estado, [Planta] = @Planta, [CCosto] = @CCosto WHERE [Area] = @Area">
        <DeleteParameters>
...
<p>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Area" DataSourceID="BopDBAreas">
        <Columns>
