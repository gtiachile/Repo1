...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        ...
        <asp:SqlDataSource ID="BopDBUnidades" runat="server" ConnectionString="<%$ ConnectionStrings:BopDBConnectionString %>" DeleteCommand="DELETE FROM [Unidades] WHERE [Unidad] = @Unidad" InsertCommand="p_ValidaInsertaUnidad" SelectCommand="SELECT [Unidad], [Descripcion], [Estado], [Tipo] FROM [Unidades]" UpdateCommand="UPDATE [Unidades] SET [Descripcion] = @Descripcion, [Estado] = @Estado, [Tipo] = @Tipo WHERE [Unidad] = @Unidad" InsertCommandType="StoredProcedure">
            <DeleteParameters>
