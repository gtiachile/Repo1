...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
            ...
            <InsertItemTemplate>
                &nbsp;<table style="width:100%;">
                    <tr>
                        ...
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="DescripciónTextBox" ErrorMessage="*Obligatorio" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>Planta:</td>
        ...
        <asp:SqlDataSource ID="BopDBTurnosPlanta" runat="server" ConnectionString="<%$ ConnectionStrings:BopDBConnectionString %>" DeleteCommand="DELETE FROM [TurnoPlanta] WHERE [Codigo] = @Codigo" InsertCommand="p_ValidaInsertaTURNOPLANTA" SelectCommand="SELECT [Codigo], [Descripción], [Planta], [Turno], [DotacionStd], [Estado], [HoraInicio], [HoraFin] FROM [TurnoPlanta]" UpdateCommand="UPDATE [TurnoPlanta] SET [Descripción] = @Descripción, [Planta] = @Planta, [Turno] = @Turno, [DotacionStd] = @DotacionStd, [Estado] = @Estado, [HoraInicio] = @HoraInicio, [HoraFin] = @HoraFin WHERE [Codigo] = @Codigo" InsertCommandType="StoredProcedure">
            <DeleteParameters>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Codigo" DataSourceID="BopDBTurnosPlanta" Width="60%">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Planta" SortExpression="Planta">
                    ...
                    <ItemTemplate>
                        <asp:DropDownList ID="DropDownList4" runat="server" DataSourceID="BopDBPlantaGV" DataTextField="Descripción" DataValueField="Planta" Enabled="False" SelectedValue='<%# Bind("Planta") %>'>
                        </asp:DropDownList>
                        <asp:SqlDataSource ID="BopDBPlantaGV" runat="server" ConnectionString="<%$ ConnectionStrings:BopDBConnectionString %>" SelectCommand="SELECT [Planta], [Descripción] FROM [Plantas]"></asp:SqlDataSource>
                    </ItemTemplate>
                </asp:TemplateField>
