...
<p>
    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Planta" DataSourceID="BopDBPlantas">
            <Columns>
                <asp:CommandField ButtonType="Image" CancelImageUrl="~/Images/StopHS.png" DeleteImageUrl="~/Images/DeleteHS.png" EditImageUrl="~/Images/EditTableHS.png" ShowDeleteButton="True" ShowEditButton="True" UpdateImageUrl="~/Images/saveHS.png" />
                ...
                <asp:TemplateField HeaderText="Centro" SortExpression="Centro">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("Centro") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:SqlDataSource ID="BopDBPlantas" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:BopDBConnectionString %>" DeleteCommand="DELETE FROM [Plantas] WHERE [Planta] = @original_Planta AND [Descripción] = @original_Descripción AND [Estado] = @original_Estado AND [Centro] = @original_Centro" InsertCommand="INSERT INTO [Plantas] ([Planta], [Descripción], [Estado], [Centro]) VALUES (@Planta, @Descripción, @Estado, @Centro)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT [Planta], [Descripción], [Estado], [Centro] FROM [Plantas]" UpdateCommand="UPDATE [Plantas] SET [Descripción] = @Descripción, [Estado] = @Estado, [Centro] = @Centro WHERE [Planta] = @original_Planta AND [Descripción] = @original_Descripción AND [Estado] = @original_Estado AND [Centro] = @original_Centro">
            <DeleteParameters>
